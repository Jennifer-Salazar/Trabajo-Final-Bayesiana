...
El placer de conducir un Mazda se eleva aún más en el Mazda3 sedán. La reducción de vibraciones y la excelente insonorización, afectados por todos los ocupantes tengan un viaje más confortable.

El Mazda3 de nueva generación está equipado en todas sus versiones con:

* sistema de control G-Vectoring Plus (GVC +)

* Mazda Connect, muestra información múltiple de 7 ”que se ubica en la parte central del tablero de instrumentos".
...
* Desde las versiones Touring, Mazda3 cuenta con Apertura inteligente de puertas.
...
knitr::include_graphics("Imagenes_elicitaciones/ficha_tecnica_2012.pdf")
```
...
**Ejemplo:** Se espera que un carro que sea del año 2015 tenga un precio de aproximadamente 43 millones de pesos colombianos $Precio = -8104.095958+4.043284 \times 2015 = 43.121302 \approx 43~millones$
