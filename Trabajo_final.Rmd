...
<iframe width="700" height="394" src="https://drive.google.com/file/d/1362bVbhGy0ZnYH0_A34PriRkDlcr83er/view?usp=sharing" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
...
Datos_experto <- data.frame(Datos_experto)
```
...
## Gráfico de las distribuciones a priori del precio del Mazda 3 para el modelo 2012 y 2016

distribución del precio Mazda 3 modelo 2012

```{r}
plot(Datos_experto$Precio, Datos_experto$X2012, type='l',ylab='Densidad',xlab='Precio del Mazda 3 en millones de pesos', pch=19, col="purple", main="Distribución del precio Mazda 3 modelo 2012")
grid()
```
...
```{r}
plot(Datos_experto$Precio, Datos_experto$X2016, type='l',ylab='Densidad',xlab='Precio del Mazda 3 en millones de pesos', pch=19, col="blue", main="Distribución del precio Mazda 3 modelo 2016")
grid()
```
