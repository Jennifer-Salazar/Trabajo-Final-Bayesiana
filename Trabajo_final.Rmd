---
title: "Tasa de cambio del precio de oferta de un mazda 3 a través de los años"
...
#main :not(.leaflet-control) > a {
    background-image: linear-gradient(180deg,#008C94,#008C94);
...
Es por todos esos atributos que esta generación del Mazda 3 es considerada como una de las mejores ofertas disponibles hoy en día en el mercado de los autos usados o seminuevos, además de aportar la confiabilidad y durabilidad que caracteriza a los productos de Mazda. Ya que el Mazda 3 es un modelo muy comercial, el cual ha ganado varios premios que lo convierte en un carro fácil de reconocer y encontrar en el mercado, sus precios son accesibles y presenta un diseño atractivo, por estas razones se decide estudiar el precio promedio de este vehículo en función del año, por otro lado, el experto confirma que posee un gran conocimiento sobre los mazda 3 (es su carro particular actualmente) y siente bastante gusto por estos.

**Lemas dados por la empresa MAZDA:** 

"El potencial humano y las cosas increíbles que hacen las personas son la fuente de nuestra inspiración, por eso hacemos parte de la grandeza en su camino con un vehículo capaz de encender sus sentidos, con un diseño mundialmente galardonado y creado para darles una experiencia de conducción en perfecta armonía."
...
En enero de 2019 el Mazda 3 se convirtió en el vehículo más rápidamente vendido de Mazda, con unas ventas acumuladas de más de 6 millones de unidades.

El Mazda 3 ha recibido más de 130 premios en su vida comercial entre los que se destacan el galardón de diseño Autobild (2009), uno de los más reconocidos en Europa, que recogió la opinión de 200 mil lectores de la revista en 27 países. Ellos eligieron al Mazda 3 como el modelo más atractivo del segmento de vehículos compactos. Por su parte la revista JD Power lo calificó como el modelo mejor vendido en la encuesta de satisfacción del consumidor en el 2011 después de ser el compacto número 1 en el 2010. Adicional a estos premios, recibió alrededor de 50 títulos como "vehículo del año" en diferentes países alrededor del mundo.
...
![](Imagenes_carros/Generacion1_foto1.png){width="33%"} ![](Imagenes_carros/Generacion1_foto2.png){width="33%"} ![](Imagenes_carros/Generacion1_foto3.png){width="33%"}

</p>

<br>

La primera generación se convirtió en un éxito de ventas en diferentes mercados del mundo en los que obtuvo el primer lugar entre los más vendidos y también recibió múltiples reconocimientos por su diseño. Esto se reflejó en que el 8 de septiembre de 2006, Mazda anuncio la producción de la unidad 1 millón de este modelo, todo un récord en tan corto tiempo.

El Mazda 3 está basado en la plataforma C1 global de Ford, compartida con el Ford Focus europeo y el Volvo S40 de la época. Como se vio inicialmente con el automóvil concepto MX-Sportif, el Mazda 3 estuvo disponible en dos estilos de carrocería, un fastback cuatro puertas sedán, comercializado como un "cuatro puertas cupé" en Europa, y un cinco puertas hatchback, comercializado como versión Sport en Canadá, Japón y en los Estados Unidos.
...
![](Imagenes_carros/Generacion2_foto2.png){width="33%"} ![](Imagenes_carros/Generacion2_foto1.png){width="33%"} ![](Imagenes_carros/Generacion2_foto3.png){width="33%"}
...
<p style = 'text-align:center;'>
![](Imagenes_carros/Generacion4_foto1.png){width="33%"} ![](Imagenes_carros/Generacion4_foto2.png){width="33%"} ![](Imagenes_carros/Generacion4_foto3.png){width="33%"}
...
### Constructores y distribuidores
...
### Tipos de usuarios de este vehículo
...
<p style = 'text-align:center;'>
**Mazda 3 en la actualidad** 
</p>

El placer de conducir un Mazda se eleva aún más en el Mazda 3 sedán. La reducción de vibraciones y la excelente insonorización, afectados por todos los ocupantes tengan un viaje más confortable.

El Mazda3 de nueva generación está equipado en todas sus versiones con:

* Sistema de control G-Vectoring Plus (GVC +)

* Mazda Connect, muestra información múltiple que se ubica en la parte central del tablero de instrumentos.

* Computador de abordo, luces delanteras LED Encendido por botón, apagado automático de luces y espejos retrovisores exteriores abatibles eléctricamente de forma automática.

* Desde las versiones Touring, Mazda3 cuenta con Apertura inteligente de puertas, sensores de parqueo delanteros y traseros.

* Cámara de reversa

* Asientos traseros con descansabrazos central

* Aire acondicionado automático dual y limpiaparabrisas delantero automático (sensor lluvia).

* Las versiones Grand Touring y Grand Touring LX están disponibles con: Techo corredizo “Sunroof”, sistema de sonido BOSE® con 12 parlantes y Pantalla Activa de Conducción de proyección en el panorámico.

<br>

##### Elección del modelo de carro particular:

Dado que se debe utilizar un carro en particular vamos a concentrar este estudio en el mazda 3 sedán (4 puertas) de caja manual el cual es el más común en el mercado y crea un mayor interés a los investigadores y al experto, además de ello como se realiza el planteamiento de un modelo de regresión lineal simple para la modelación de los precios de oferta solo es necesario tener en cuenta dos años de carros los cuales fueron escogidos el mazda 3 sedán modelo 2012 y modelo 2016, que fueron escogidos por el experto, porque desde su perspectiva son los dos modelos de mazda 3 de segunda más comerciales.

<br>

### Ficha técnica Mazda 3 modelo 2012

<iframe src="https://docs.google.com/viewer?srcid=1HcRAgfuhaeSvF8iD_tgbN2q2gcOZPd3U&pid=explorer&efh=false&a=v&chrome=false&embedded=true" width="100%" height="680px"></iframe>

<hr>

### Ficha técnica Mazda 3 modelo 2016

<iframe src="https://docs.google.com/viewer?srcid=1lUQxSbIntCsguPjHesIrXECogT2Sv5ul&pid=explorer&efh=false&a=v&chrome=false&embedded=true" width="100%" height="680px"></iframe>
...
Las elicitaciones como tal nos permiten hallar una distribución a priori para un parámetro el cual se está estudiando, de tal manera que mediante una distribución se pueda representar el conocimiento que tiene el experto bajo el problema de estudio, por lo tanto en este estudio los parámetros los cuales se le quiere hallar su distribución a priori son los asociado a un modelo de regresión lineal simple, en donde su variable respuesta (dependiente) es el precio de oferta del vehículo y la covariable(variable independiente) es el año (modelo del vehículo).
...
$$Y=\text{Precio de oferta},~~X=\text{Año del vehiculo}$$
...
Una de las principales dificultades a la hora de obtener conocimiento del experto es seleccionar y formular las preguntas adecuadas de tal manera que los expertos comprendan lo que se está preguntando y proporcionen realmente la información esperada. Para este propósito, se debe preparar cuidadosamente una lista de preguntas. Sin embargo, durante el proceso de elicitación, la estructura de una pregunta podría cambiar ligeramente, siempre que no se altere su significado subyacente. Por lo tanto, se deben examinar todos los métodos de elicitación para identificar el vocabulario apropiado para las preguntas y comparar todas esas características en función de los diferentes parámetros a estimar. En otras palabras, en lugar de utilizar preguntas estructurales en un proceso de elicitación, debemos adaptarlas a cada experto e intentar interactuar con ellos durante el proceso de entrevista / encuesta.
...
Recordar: Los años elegidos para el estudio del precio de oferta mediante un proceso de elicitación son el 2012 y 2016.

<br>

#### Elicitación gráfica a mano alzada de los precios de oferta de automóviles mazda 3 sedán modelo 2012 y 2016:
...
**Plantilla de elicitación para los precios de oferta de automóviles mazda 3 sedán modelo 2012**
...
**Plantilla de elicitación para los precios de oferta de automóviles mazda 3 sedán modelo 2016**
...
[Elicitación ficticia de los precios de oferta de los mazda 3](https://youtu.be/ovzBAo133WA)



<div>
<p style = 'text-align:center;'>
<iframe width="642" height="361" src="https://www.youtube.com/embed/ovzBAo133WA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
</p>
...
- Hay que entablar preguntas inicialmente que permitan un vinculo con el experto.   

- Dar claridad al experto del cambio de opinión que puede tener durante el proceso de elicitación y posterior a este.   
...
- No volver el proceso de elicitación tan mécanico o repetitivo para no cansar al experto, intentar el uso de diferentes terminologias que lleven a la misma idea.

<br>

## Aplicación del Método de Elicitación

*Momento de elicitar a nuestro experto*
...
A el experto se le explico cómo debía realizar cada uno de los procesos de elicitación, se le dieron las pautas y toda la información necesaria para ayudar a guiarlo en su proceso de estimación, los facilitadores lo estuvo acompañando aproximadamente 3 horas en las que el experto estuvo analizando con mucha calma todo, luego de eso, se comenzó a la realización del proceso de elicitación el cual fue grabado para que los facilitadores después pudieran hacer uso de este recurso y utilizarlo en su análisis.

[Proceso de Elicitación a un Experto en compra y venta de carros de segunda](https://youtu.be/y0j3xFTAkjM)

<div>
<p style = 'text-align:center;'>
<iframe width="642" height="361" src="https://www.youtube.com/embed/y0j3xFTAkjM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
</p>
...
**Elicitación para el mazda 3 sedán modelo 2012**
...
**Elicitación para el mazda 3 sedán modelo 2016**
...
Al experto durante el proceso de elicitación se le aclaro constantemente que en cualquier momento si cambia de opinión lo puede comunicar sin problema alguno, ya que esto hacia parte del proceso e incluso era una buena práctica, además de esto, dias posterior al proceso de elicitación hubo una comunicación con el experto preguntandole si preferia cambiar o se sentia inseguro de algunas de las estimaciones que nos habia dado durante el proceso de elicitación, pero este reiteraba que se sentia seguro de las estimaciones dadas, particularmente porque antes de realizar el proceso de elicitación le dimos un tiempo muy prudente para pensar y lo habia hecho de manera correcta desde su perspectiva.
...
### Gráfico de las distribuciones dadas por el experto del precio de oferta del Mazda 3  modelo 2012 y 2016
...
* Según el experto el precio promedio del mazda 3 modelo 2012 es aproximadamente de 31 millones con una desviación estándar de aproximadamente 6.6 millones.
...
* Según el experto el precio promedio del mazda 3 modelo 2016 es aproximadamente de 47 millones con una desviación estándar de aproximadamente 9 millones.

<br>

## Simulación para la obtención de la distribución apriori

Con la media y la varianza obtenidas anteriormente de las distribuciones de los precios de oferta de automoviles mazda 3 modelo 2012 y modelo 2016 se procede a extrar una muestra de tamaño **n equivalente** de una distribución normal con las medias y varianzas respectivas, esto se debe a que estamos bajo el supuesto de que los precios siguen una distribución normal, planteado en el modelo de regresión lineal simple.


el n equivalente es dado por el experto, de acuerdo al nivel de experticie del experto en cada una de las distribuciones estimadas:
...
Este proceso se realiza con el interés de obtener los parámetros del modelo de regresión lineal simple $\beta_0,~\beta_1,~ \sigma^2$
...
**En donde para los datos anteriores se obtuvo el siguiente modelo estimado:**
...
for(i in 2:1000){
  ...
  sigma_2 <- summary(modelo)$sigma^2
...
### Tabla de parámetros estimados dados por la distribución apriori

```{r, echo = FALSE}
kable(df_parametros, col.names = c("Beta 0", "Beta 1", "Varianza"), caption = "Parametros estimados del modelo de regresión lineal simple obtenidos mediante simulación",row.names = TRUE) %>%
  kable_paper() %>%
  row_spec(0, bold = T, color = "white", background = "#039794")  %>%
  scroll_box(width = "100%", height = "200px")
```
...
**Gráfica de la distribución de beta 0**

```{r fig.align="center", echo=FALSE}
hist(df_parametros$beta_0, xlab='Beta 0', ylab='Densidad', main = expression(paste("Distribución de ", beta[0], " estimado")), col="cyan3", freq = FALSE, ylim = c(0,0.0003))
...
**Gráfica de la distribución de beta 1**

```{r fig.align="center", echo=FALSE}
hist(df_parametros$beta_1, xlab='Beta 1', ylab='Densidad', main=expression(paste("Distribución de ", beta[1], " estimado")), col="cyan3", freq = FALSE, ylim = c(0, 0.60))
...
**Gráfica de la distribución de la Varianza**

```{r fig.align="center", echo=FALSE}
hist(df_parametros$sigma_2, xlab='Varianza', ylab='Densidad', main=expression(paste("Distribución de ", sigma^2, " estimado")), col="cyan3", freq = FALSE)
...
Al vector de parámetros $\beta=(\beta_0, \beta_1)$ se le ajusta una distribución normal bivariada por lo tanto se procede a calcular el vector de medias y la matriz de varianza y covarianzas (también su inversa) de los $\beta$, las cuales se usarán como parámetros para la estimación de la distribución normal bivariada, por otro lado, a la varianza $\sigma^2$ se le ajusta una gamma inversa, mediante el vector de varianzas estimados, se calculan los parámetros de forma y escala asociados a la gamma inversa.
...
La tasa de cambio del precio de oferta de un mazda 3 aumenta aproximadamente 4 millones por cada año que aumenta el modelo del carro.

**Ejemplo:** Se espera que un carro que sea del año 2015 tenga un precio de aproximadamente 43 millones de pesos colombianos: 


$$Precio = -8104.095958+4.043284 \times 2015 = 43.121302 \approx 43~millones$$
...
#### Estimación parametros Gamma Inversa como apriori para $\sigma^2$
...
$$c0=\hat{\alpha}_0 = `r alfa`$$

Parámetro de escala

$$d0=\hat{\gamma}_0 = `r beta`$$
...
La distribución apriori es una función de que tiene como argumentos los parámetros hallados a partir de los modelo de regresión lineal simple $(\beta_0, \beta_1, \sigma^2)$:

$$\xi(\beta, \sigma^2) = \xi(\beta|\sigma^2)\xi(\sigma^2)=N(\mu_{\beta}, \sigma^2 \Sigma_{\beta})\times IG(\alpha_0, \gamma_0)$$

$$Apriori = f(\beta_0, \beta_1, \sigma^2)=Normal(\beta_0,\beta_1 |b0,B0)\times GammaInv(sigma^2|c0,d0)$$


La cuál es una distribución que esta en tres dimensiones determinada por los tres parámetros que la conforman.
...
Se realiza una búsqueda en páginas de internet en donde se realizan ventas de carros de segunda (usados) en donde cada dueño coloca el respectivo precio de oferta que considera adecuado para su automóvil, se extrae una muestra de precios del Mazda 3 modelo 2012 y modelo 2016, cada una de las muestras son de tamaño 15 y son presentadas a continuación:
...
* El precio de oferta promedio de un mazda 3 modelo 2012 dado por la muestra es de 34 millones aproximadamente el cual comparado con el precio promedio dado por el experto, lo supera en 3 millones (el del experto era de aproximadamente 31 millones) los cuales no difieren mucho.

* El precio de oferta promedio de un mazda 3 modelo 2016 dado por la muestra es de 52.5 millones aproximadamente el cual comparado con el precio promedio dado por el experto, lo supera en 5.5 millones (el del experto era de aproximadamente 47 millones) los cuales no difieren pero no tanto.

<br>

**Desviación estándar de los precios de oferta obtenidos mediante las muestras extraídas a partir de internet tanto para el modelo 2012 y modelo 2016**
...
* La desviación estándar de los precios de oferta para el año 2012 según la muestra es de aproximadamente 2.6 millones de pesos, la cual comparada con la desviación dada por el experto es menor por 4 millones (la del experto es de aproximadamente 6.6 millones) lo que indica que la muestra es más precisa o menos dispersa que las estimaciones dadas por el experto.

* La desviación estándar de los precios de oferta para el año 2016 según la muestra es de aproximadamente 3.7 millones de pesos, la cual comparada con la desviación dada por el experto es menor por 5.3 millones (la del experto es de aproximadamente 9 millones) lo que indica que la muestra es más precisa o menos dispersa que las estimaciones dadas por el experto.

* En general las estimaciones de la muestra son más precisa o menos dispersas que las dadas por el experto aunque se considera que ambas dispersiones no son grandes.

* Hay mayor dispersión en los precios de oferta del modelo 2016 que del modelo 2012.
...
* Para los precios de oferta del modelo 2012 extraido mediante la muestra se tiene que:

   - el precio minimo es de 29.9 millones
   - el precio maximo es de 39.9 millones
   - el 50% tiene un precio inferior a 33.8 millones
   
   
   
   
* Para los precios de oferta del modelo 2016 extraido mediante la muestra se tiene que:

   - el precio minimo es de 45.2 millones
   - el precio maximo es de 57.9 millones
   - el 50% tiene un precio inferior a 53.49 millones
...
* La mayor frecuencia de precios de oferta modelo 2012 está entre los 32 y 34 millones.

* La mayor frecuencia de precios de oferta modelo 2016 está entre los 52 y 54 millones.

* Se observa una falta de precios de oferta entre los 30 y 32 millones para el modelo 2012.

* Se observa una falta de precios de oferta entre los 46 y 48 millones para el modelo 2016.

* La distribución de los precios de oferta para el modelo 2012 parecen ser más simétricos que los del modelo 2016.

* Los precios de oferta de ambos modelos de Mazda 3 no se traslapan.
...
* Se observa una relación positiva entre el precio de oferta y el año, el cual era de esperarse

* La tasa de cambio del precio de oferta respecto al año es de aproximadamente 4.6 millones, es decir, se espera que al aumentar el modelo del mazda 3 en un año, el precio promedio deberia aumentar 4.6 millones aproximadamente.  
...
Este hace uso de la distribución apriori y de la muestra de internet para la contrucción del modelo de regresión lineal simple bayesiano o distribución posteriori.

Para el ajuste, se hace uso de la función del R llamada **MCMCregress** del paquete **MCMCpack**

```{r}
require(MCMCpack)
modelo <- MCMCregress(Precio~Año, data=muestra, b0=media, B0=precision, c0=alfa, c1=beta)
```
...
$$Precio = -8088 + 4.035 * Año$$

<br>

A continuación se realiza el mismo análisis de los parámetros obtenidos mediante la distribución posterior:

### Tabla de parámetros estimados dados por la distribución posterior

```{r, echo = FALSE}
require(kableExtra)
kable(modelo, col.names = c("Beta 0", "Beta 1", "Varianza"), caption = "Parametros de modelo de regresión lineal simple obtenidos via MCMC") %>%
  kable_paper() %>%
  row_spec(0, bold = T, color = "white", background = "#039794")  %>%
  scroll_box(width = "100%", height = "200px")
```
...
```{r fig.align="center", echo=FALSE}
hist(modelo[,1], xlab='Beta 0', ylab='Densidad', main = expression(paste("Distribucion de ", beta[0], " estimado")), col="cyan3", freq = FALSE, ylim = c(0,0.0003))
lines(density(modelo[,1]), lwd=1.5)
grid()
```
...
```{r fig.align="center", echo=FALSE}
hist(modelo[,2], xlab='Beta 1', ylab='Densidad', main=expression(paste("Distribucion de ", beta[1], " estimado")), col="cyan3", freq = FALSE, ylim = c(0, 0.60))
lines(density(modelo[,2]), lwd=1.5)
grid()
```
...
```{r fig.align="center", echo=FALSE}
hist(modelo[,3], xlab='Varianza', ylab='Densidad', main=expression(paste("Distribucion de ", sigma^2, " estimado")), col="cyan3", freq = FALSE)
lines(density(modelo[,3]), lwd=1.5)
grid()
```
...
#### Gráficos comparativos de las distribuciones de los parámetros del modelo de regresión lineal simple dado por el experto y el obtenido mediante el análisis bayesiano

**Gráfica de la distribución de los** $\beta$

```{r fig.align="center", echo=FALSE}

par(mfrow=c(1,2))
plot(density(df_parametros$beta_0, add = TRUE), col = "cyan4", main="Gráfico comparativo de beta 0", xlab="Beta 0", lwd=2)
lines(density(modelo[,1], add = TRUE), col = "blue",lwd=2)
legend("topright", legend=c("Apriori", "posteriori"),col=c("cyan4", "blue"),lwd=2, bty = "n", cex=0.8)
grid()

plot(density(df_parametros$beta_1, add = TRUE), col = "cyan4", main="Gráfico comparativo de beta 1", xlab="Beta 1", lwd=2)
lines(density(modelo[,2], add = TRUE), col = "blue", lwd=2)
legend("topright", legend=c("Apriori", "posteriori"),col=c("cyan4", "blue"),lwd=2, bty = "n", cex=0.8)
grid()
```


* Mediante los gráficos se puede notar la gran similaridad entre las estimaciones de los parámetros de los modelos de regresión lineal simple, dado por el experto como distribución apriori y el cálculado como distribución posteriori.

<br>

<hr>

## Parámetros de la distribución posteriori

**Media de los** $\beta$

```{r, echo=FALSE}
b1<-colMeans(modelo[,1:2])
```
...
$$Precio = -8088.042632+ 4.035309 \times 2015 = 43.105 \approx 43~millones$$
...
```{r, echo=FALSE}
var_pos <- var(modelo[,1:2])
B1<-solve(var(modelo[,1:2]))

```


$$B1=\hat{\Sigma}^{-1}_\beta=
\begin{bmatrix}
`r B1[1,1]` & `r B1[1,2]`\\
`r B1[2,1]` & `r B1[2,2]`\\
\end{bmatrix}$$
...
$$c1=\hat{\alpha}_1 = `r c1`$$

Parámetro de escala

$$d1=\hat{\gamma}_1 = `r d1`$$


<br>

**Comparación de los parámetros de la distribución apriori con la distribución posteriori**

```{r, echo=FALSE}
parametros <- data.frame(beta_0 = c(media[1], b1[1]), beta_1=c(media[2], b1[2]),  var_b0 = c(var[1,1], var_pos[1,1]), var_b1 = c(var[2,2], var_pos[2,2]), cov_b0_b1 = c(var[1,2], var_pos[1,2]),alfa = c(alfa, c1), beta=c(beta, d1), row.names = c("Apriori", "Posteriori"))
kable(parametros, col.names = c("β₀", "β₁", "Var(β₀)", "Var(β₁)","Cov(β₀, β₁)","c (forma)", "d (escala)"), caption = "Parametros del modelo de regresión lineal Mediante la distribución apriori y la distribución posteriori", row.names = T) %>%
  kable_paper() %>%
  row_spec(0, bold = T, color = "white", background = "#039794")  
```
...
Todos los parámetros presentados en la tabla anterior fueron los calculados para la aproximación de la distribución apriori y la distribución posterior, la idea es comparar la gran similaridad que hay entre estos, indicando que la información del experto es acertada respecto a la realidad de los precios de oferta del mazda 3 sedán.

Conclusión: En base al resultado del promedio del $\beta_0$ y en especial del $\beta_1$ que es la tasa de cambio del precio de oferta de los mazda 3 dado el año  hallado a partir de la distribución dada por el experto (distribución apriori) y a partir de la obtenida mediante la muestra y la distribución apriori (distribución posteriori) se ve la gran similaridad entre estas, en ambas la tasa de cambio del precio de oferta es de aproximadamente 4 millones, lo que denota que la estimación de los precios de oferta dados por el experto son demasiado similares a los extraidas en la muestra de internet, lo que indica que el conocimiento del experto da confiabilidad; realmente el cambio se ve en es la varianza que se estima en los modelos de regresión mediante la información dada por el experto y la extraida de internet y esto se nota en las diferencias de los parámetros de escala y forma.

<br>

**Gráfico de la distribución conjunta entre ** $\beta_0$ **y** $\beta_1$

```{r, echo=FALSE}
library(ash)
ab <- matrix( c(0,-13000,8,-3000), 2, 2)
nbin <- c( 20, 20) # 400 bins
bins <- bin2(modelo[,c(2,1)], ab, nbin)
m <- c(5,5)
f <- ash2(bins,m)
image(f$x,f$y,f$z, xlab="beta 1", ylab="beta 0")
contour(f$x,f$y,f$z,add=TRUE)
```


Densidad de tipo no parámetrica: como es de esperarse, se parece a los contornos proveniente de una normal bivariada.


## Conclusiones y Recomendaciones

- Se logra obtener una buena estimacicón de un modelo del precio de oferta de un mazda 3 a tráves de los años y con todo el análisis se destaca que se puede construir un buen modelo desde el conocimiento de un experto en el tema y la muestra nos permitio corroborar esto.

- Los modelos bayesianos son de gran utilidad ya que nos permiten valorar tanto el conocimiento de un experto en el tema como la muestra y en el caso que estos difieran, crear un balance entre estos.

-  El proceso de elicitación es una tarea la cual requiere una buena comunicación con el experto, ya que este se debe sentir cómodo con las preguntas que se le realizan, debe comprender lo importante que es para la investigación y que de verdad exprese su conocimiento o perspectiva frente al tema que se está estudiando.

- Es de suma importancia después de un tiempo prudente preguntarle al experto si sigue teniendo la misma perspectiva o la ha cambiado y hacer un registro de ello, de tal manera que las estimaciones de verdad reflejen el pensamiento y conocimiento del experto.

- Es muy recomendable realizar el proceso de elicitación ficticia ya que este permite tener una preparación de cuál es la comunicación más acertada que se debe tener con el experto.

- Algo muy positivo a resaltar de este estudio es que el experto genero una gran seguridad en sus estimaciones, realmente notamos su gran conocimiento en el tema, por lo tanto se concluye que el proceso de elicitación fue exitoso.

-  Una de las dificultades es buscar al experto, ya que este problema bajo estudio requeria un experto en la compra y venta de carros de segunda y este oficio particularmente no es común encontrar personas que lo ejerzan, además de que es un poco incomodo pedir tanta disponibilidad de tiempo por parte del experto.

- El proceso de elicitación es una muy buena herramienta para sacar estimaciones de problemas de estudio que mediante otras técnicas generan gran dificultad y además de ello son costosos, porque el proceso de elicitación no requiere muchos datos y además valora a expertos en el tema, lo cual debería ser más acertado.

- Una técnica utilizada en este estudio y que es de suma utilidad son las simulaciones ya que estos nos permitieron obtener unas buenas distribuciones dando peso respecto a la experiencia o conocimiento que el experto tenia frente al tema.
...
* Garthwaite P., Kadene J. y O’Hagan A., 2005, Statistical Methods for Eliciting Probability Distribu-tions,Journal of the American Statistical Association,Vol. 100, 680-700, No.470.

* James, A., Choy, S. L. & Mengersen, K. (2010), ‘Elicitator: An expert elicitation tool for regression in ecology’, Environmental Modelling & Software 25, 129–145.

* Kadane J., Wolfson L., 1998, Experiencies in Elicitation,The Statistician,Vol. 47, 3-19, No. 1.


* O’Hagan, A. (2019), ‘Expert knowledge elicitation: Subjective but scientific’, The American Statistician 73(sup1), 69–81.

* Seynaeve, D., Varewyck, M. & Verbeke, T. (2019), ‘Extension of the montecarlo web application and expert knowledge elicitation web application’, EFSA Supporting Publications 16(6), 1630E.

* Van Lenthe J., 1993, A blueprint of ELI: A new method for eliciting subjective probability distributions,Behavior Research Methods, Instruments, & Computers,Vol 25, 425-433, No. 4.
...
Lectura del conjunto de datos de las estimaciones del experto:
...
Codigo que imprime el conjunto de datos
...
Gráfico de la distribución del precio Mazda 3 modelo 2012 dado por el experto
...
Calculo del promedio y varianza de la distribución del precio Mazda 3 modelo 2012 dado por el experto
...
Codigo que presenta la tabla con la media, la varianza y desviación (2012):
...
Gráfico de la distribución del precio Mazda 3 modelo 2016 dado por el experto
...
Calculo del promedio y varianza de la distribución del precio Mazda 3 modelo 2016 dado por el experto
...
Codigo que presenta la tabla con la media, la varianza y desviación (2016):
...
Simulación mediante la distribución normal de la muestra de tamaño 15 de la información dada por el experto para el año 2012
...
Tabla de la muestra para el modelo 2012:
...
Simulación mediante la distribución normal de la muestra de tamaño 15 de la información dada por el experto para el año 2016
...
Tabla de la muestra para el modelo 2016:
...
Conjunto de datos utilizado para el ajuste del modelo de regresión lineal simple
...
Ajuste del modelo y extracción de los parámetros de dicho modelo
...
Simulación de 1000 muestras para el ajuste de 1000 modelos de regresión lineal simple e inclusión de los parámetros de estos a un data.frame
...
Tabla que muestra los parametros de los 1000 modelos simulados
...
Gráfica de la distribución de beta 0 (Apriori)
...
Gráfica de la distribución de beta 1 (Apriori)
...
Gráfica de la distribución de la Varianza (Apriori)
...
Calculo del vector de medias de los betas (Apriori)
...
Calculo de la matriz de varianza y covarianzas de los betas (Apriori)

```{r}
var <- var(df_parametros[,-3])
```

Calculo de la matriz de varianzas y covarianzas inversa o matriz de presición de los betas (Apriori)

```{r}
precision <- solve(var(df_parametros[,-3]))
```

Calculo de los parámetros de la gamma inversa (Apriori)
...
Lectura del conjunto de datos de la muestra extraida de internet
...
Separación de la muestra del 2012 y 2016 para el análisis descriptivo
...
Promedios de las muestras extraidas de internet
...
Desviación de las muestras extraidas de internet
...
Cuantiles de las muestras extraidas de internet
...
Densidad de las muestras extraidas de internet
...
Ajuste y gráfica del modelo de regresión lineal simple de la muestra extraida de internet
...
Ajuste del modelo bayesiano (distribución posteriori) el cual tiene en cuenta la muestra y la información de la distribución apriori
...
Gráfica de la distribución de beta 0 (Posteriori)
...
Gráfica de la distribución de beta 1 (Posteriori)
...
Gráfica de la distribución de la Varianza (Posteriori)
...
Gráfico comparativo de los parametros de las distribuciones apriori y posteriori
...
Vector de medias de los betas (Posteriori)
...
Matriz de varianzas y covarianza e inversa de los betas (Posteriori)
...
Calculo de los parámetros de la gamma inversa (Posteriori)
...
Gráfico de la distribución conjunta entre los betas
