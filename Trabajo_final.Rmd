...
### Gráficos comparativos de las distribuciones de los parámetros de la distribución apriori y la posteriori

**Gráfica de la distribución de beta 0**

```{r fig.align="center", echo=FALSE}
plot(density(df_parametros$beta_0, add = TRUE), col = "cyan4", main="Gráfico comparativo de beta 0", xlab="Beta 0")
lines(density(modelo[,1], add = TRUE), col = "blue")
grid()
```
