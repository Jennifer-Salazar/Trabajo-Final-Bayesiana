...
```{r fig.align="center"}
hist(df_parametros$beta_0, xlab='Beta 0', ylab='Densidad', main = expression(paste("Distribucion de ", beta[0])), col="cyan3", freq = FALSE, ylim = c(0, 0.000099))
...
```{r fig.align="center"}
hist(df_parametros$beta_1, xlab='Beta 1', ylab='Densidad', main=expression(paste("Distribucion de ", beta[1])), col="cyan3", freq = FALSE, ylim = c(0, 0.20))
...
```{r fig.align="center"}
hist(df_parametros$sigma_2, xlab='sigma_2', ylab='Densidad', main=expression(paste("Distribucion de ", sigma^2)), col="cyan3", freq = FALSE)
